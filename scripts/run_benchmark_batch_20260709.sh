...
IP="74.249.212.125"
RUN_ROOT="/home/azureuser/harnesseng_vm/scripts/aether_next/vm_goal_runs/${RUN_ID}"
...
for task in $TASKS; do
  ...
  ssh -i ~/.ssh/id_rsa azureuser@$IP "
    ...
    nohup python3 /home/azureuser/harnesseng_vm/scripts/aether_next/run_pilot.py \
      --tasks '${task}' \
      --max-steps 500 \
