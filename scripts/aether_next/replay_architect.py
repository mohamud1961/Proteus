...
from proteus.aether_next.compiler import CapabilityRegistry, ConfigCompiler  # noqa: E402
from older_variants.reference_legacy.contract_compile import (  # noqa: E402
    contract_to_eval_index,
    contract_to_objective_graph,
    contract_to_runtime_ir,
)
from older_variants.reference_legacy.contract_hooks import ContractArchitect  # noqa: E402
from proteus.aether_next.envmap_builder import build_envmap_from_task  # noqa: E402
from proteus.aether_next.kernel_messages import build_architect_request  # noqa: E402
from proteus.aether_next.model_hooks import ModelHooks  # noqa: E402
from proteus.aether_next.providers.azure_model import make_azure_callable  # noqa: E402
from proteus.aether_next.repair import repair_config  # noqa: E402
from proteus.aether_next.runners.docker_helpers import seed_workspace_from_image  # noqa: E402

_OFFICIAL_TASKS_DIR = str(
    Path(__file__).resolve().parents[2] / "official_tasks"
)
