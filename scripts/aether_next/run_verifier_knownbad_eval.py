...
_BUILD_DIR = str(Path(__file__).resolve().parents[2])
_SCRIPT_DIR = str(Path(__file__).resolve().parent)
for _path in (_BUILD_DIR, _SCRIPT_DIR):
    if _path not in sys.path:
        sys.path.insert(0, _path)

from proteus.aether_next.evidence_finalization import (  # noqa: E402
    executing_source_identity,
    finalize_evidence_directory,
)
from proteus.aether_next.model_hooks import ModelHooks, ModelOutputError  # noqa: E402
from proteus.aether_next.providers.azure_model import AzureModelError  # noqa: E402
from proteus.aether_next.real_executor import SubprocessExecutor  # noqa: E402
from proteus.aether_next.runners.docker_exec_executor import DockerExecExecutor  # noqa: E402
from proteus.aether_next.runtime_ir import EnvMap  # noqa: E402
from proteus.aether_next.verifier import parse_model_verifier_result  # noqa: E402
from proteus.aether_next.verifier_inspector import (  # noqa: E402
    VerifierInspectionRequest,
    execute_verifier_inspection_requests,
)
from proteus.aether_next.verifier_overlay import VerifierOverlay  # noqa: E402
from proteus.aether_next.verifier_packets import build_verifier_packet  # noqa: E402
try:
    ...
    from run_trace_verifier_replay_ab import (
        _compiled_from_trace,
        _ledger_from_trace,
        _load_json,
        _trace_root,
...
def _model_callables(args: Any) -> tuple[Callable[..., str], Callable[..., str] | None]:
    ...
    from proteus.aether_next.providers.azure_model import make_azure_callable, make_azure_vision_callable
