...
Task taxonomy in eval_suite/evals/official_task_board.v1.json is evaluation-only. This
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--board-file", default=str(_BUILD_ROOT / "eval_suite" / "evals" / "official_task_board.v1.json"))
