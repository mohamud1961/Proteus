...
from proteus.aether_next.model_hooks import SOLVER_SYSTEM_PROMPT, parse_solver_turn  # noqa: E402
...
CASES: tuple[ReplayCase, ...] = (
    ReplayCase(
        ...
        trace="proteus/aether_next/phase2_traces/codex/filter-js-from-html.trace.json",
        step=3,
    ...
    ReplayCase(
        ...
        trace="proteus/aether_next/phase2_traces/codex/sparql-university.trace.json",
        step=15,
    ...
    ReplayCase(
        ...
        trace="proteus/aether_next/phase2_traces/codex/raman-fitting.trace.json",
        step=10,
    ...
    ReplayCase(
        ...
        trace="proteus/aether_next/phase2_traces/mini/log-summary-date-ranges.trace.json",
        step=2,
    ...
    ReplayCase(
        ...
        trace="proteus/aether_next/phase2_traces/codex/extract-elf.trace.json",
        step=10,
...
def run_case(case: ReplayCase, *, endpoint_env: str, effort: str, max_output_tokens: int) -> dict[str, Any]:
    ...
    return {
        "case": asdict(case),
        "schema_version": "proteus.aether_next.replay_ab_experiment.v1",
        "resume_limitation": (
