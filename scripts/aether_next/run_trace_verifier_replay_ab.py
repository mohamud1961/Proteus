...
from proteus.aether_next.automatic_memory import automatic_memory_receipt  # noqa: E402
from proteus.aether_next.ledger import ExecutionLedger, Receipt  # noqa: E402
from proteus.aether_next.model_hooks import DEFAULT_VERIFIER_IDENTITY_PROMPT as VERIFIER_SYSTEM_PROMPT  # noqa: E402
from proteus.aether_next.providers.azure_model import make_azure_callable  # noqa: E402
from proteus.aether_next.runtime_ir import (  # noqa: E402
    ACTION_SCHEMA,
...
from proteus.aether_next.verifier import ModelVerifierResult, parse_model_verifier_result  # noqa: E402
from proteus.aether_next.verifier_packets import build_verifier_packet  # noqa: E402
from proteus.aether_next.workbench_config import parse_harness_config_ir  # noqa: E402
...
def run(*, mode: str, out_dir: Path, cases: tuple[tuple[str, str], ...] = DEFAULT_CASES) -> dict[str, Any]:
    ...
    summary = {
        "schema_version": "proteus.aether_next.trace_verifier_replay_ab.v1",
        "mode": mode,
        "rows": rows,
        "counts": {
            "cases": len(rows),
