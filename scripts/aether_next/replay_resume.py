...
from proteus.aether_next.kernel import AetherNextKernel, KernelResult  # noqa: E402
from proteus.aether_next.ledger import Receipt  # noqa: E402
...
def main(argv: list[str] | None = None) -> int:
    ...
    from proteus.aether_next.providers.azure_model import make_azure_callable
