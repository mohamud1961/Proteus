...
from proteus.aether_next.run_adapter import ensure_certified_architect_mode  # noqa: E402
from proteus.aether_next.runners.docker_runner import run_tbench_task  # noqa: E402
from proteus.aether_next.task_metadata_loader import declared_docker_image  # noqa: E402
...
def _build_run_provenance(args: argparse.Namespace) -> dict[str, Any]:
    ...
    tree_hash = _tree_hash(build_root / "proteus" / "aether_next")
    prompt_hashes = {
...
def main(argv: list[str] | None = None) -> int:
    ...
    ap.add_argument(
        ...
        default="workbench",
        choices=["workbench"],
        help="Certified architect mode (legacy ir/contract modes are quarantined in older_variants/reference_legacy).",
    )
    ap.add_argument(
        "--vision-deploy-env",
        default="",
    ...
    if args.vision_deploy_env:
        from proteus.aether_next.providers.azure_model import make_azure_vision_callable
