...
from proteus.aether_next.kernel_solver_turn import handle_solver_parse_error  # noqa: E402
from proteus.aether_next.kernel_messages import build_solver_messages  # noqa: E402
from proteus.aether_next.ledger import ExecutionLedger  # noqa: E402
...
from proteus.aether_next.redaction import redact_text_with_events  # noqa: E402
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--cases-file", default=str(_BUILD_ROOT / "eval_suite" / "evals" / "solver_checkpoints.v1.json"))
