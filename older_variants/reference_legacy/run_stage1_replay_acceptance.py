...
from proteus.aether_next.no_progress import NoProgressController  # noqa: E402
from older_variants.reference_legacy.proof_contract import analyze_proof_contract  # noqa: E402
...
def run(root: Path, out_dir: Path, *, repair_slice_rerun_root: Path = REPAIR_SLICE_RERUN) -> dict[str, Any]:
    ...
    summary = {
        "schema_version": "proteus.aether_next.stage1_replay_acceptance.v1",
        "run_root": str(root),
