...
if TYPE_CHECKING:
    from older_variants.harness.aether2.runtime.model_routes import ModelClient
...
def _maybe_wrap_tpm_pacer(client: "ModelClient", options: dict[str, Any]) -> "ModelClient":
    if not options.get("enabled"):
        return client
    from older_variants.harness.aether2.runtime.tpm_pacer import make_paced_client
