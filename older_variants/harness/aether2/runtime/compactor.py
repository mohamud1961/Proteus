...
from older_variants.harness.aether2.traces.delta import compact_evidence_ledger
from older_variants.harness.aether2.runtime.prompts import HANDOFF_TEMPLATE
