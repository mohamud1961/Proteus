...
from older_variants.harness.aether2.traces.envelope import ErrorInfo
from older_variants.harness.aether2.traces.failure_cards import classify_failure
...
def _build_backend_model_client() -> Any:
    from older_variants.harness.aether2.runtime.bridge_harbor import _build_model_client
