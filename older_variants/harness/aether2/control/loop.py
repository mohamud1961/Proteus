...
from older_variants.harness.aether2.runtime.compactor import build_receipt_continuity_snapshot, rebase, should_rebase
from older_variants.harness.aether2.runtime.context import ContextManager
from older_variants.harness.aether2.hooks.registry import HookRegistry
from older_variants.harness.aether2.traces.delta import (
    StateSnapshot,
...
from older_variants.harness.aether2.traces.envelope import ObservationEnvelope, build_envelope
...
from older_variants.harness.aether2.traces.mirror import Mirror, MirrorNote, SemanticObservation
from older_variants.harness.aether2.runtime.orientation import orient
from older_variants.harness.aether2.runtime.adaptive_profile_helpers import solver_visible_orientation
from older_variants.harness.aether2.runtime.prompts import (
    SYSTEM_PROMPT,
)
...
from older_variants.harness.aether2.tools.permissions import PermissionManager
from older_variants.harness.aether2.tools.registry import ToolRegistry
from older_variants.harness.aether2.runtime.verify import replay_checks
from older_variants.harness.aether2.traces.redaction import _clean_hidden_refs

# --- Extracted sub-modules (pure extraction; public API unchanged) ---
from older_variants.harness.aether2.control.requirements import (
...
from older_variants.harness.aether2.control.reasoning_trace import (
...
from older_variants.harness.aether2.control.runtime_support import (
...
from older_variants.harness.aether2.control.action_helpers import (
    _error_raw,
)
from older_variants.harness.aether2.control.tail_helpers import (
    _build_tail_state,
...
from older_variants.harness.aether2.control.execution_context import (
    ExecutionContext,
    RunResult,
    ToolInvocationRecord,
)
from older_variants.harness.aether2.control.tool_dispatch import _execute_tool_calls
from older_variants.harness.aether2.control.verification_rounds import _run_verification_rounds
from older_variants.harness.aether2.control.ahp_startup import run_ahp_startup
from older_variants.harness.aether2.control.candidate_preservation import CandidatePreservation
from older_variants.harness.aether2.control.receipt_driven_variant import ReceiptDrivenVariant
from older_variants.harness.aether2.control.task_operating_contract import (
    TASK_OPERATING_CONTRACT_REQUEST,
    extract_task_operating_contract,
    has_task_operating_contract,
)
from older_variants.harness.aether2.runtime.run_config import HarnessRunConfig, build_baseline_run_config
