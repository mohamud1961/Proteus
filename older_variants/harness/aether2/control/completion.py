...
from older_variants.harness.aether2.runtime.verify import DiscrepancyReport, RequirementResult
from older_variants.harness.aether2.traces.envelope import ObservationEnvelope
...
def _build_proof_state(
    ...
    *,
    ...
    from older_variants.harness.aether2.control.requirements import _ledger_requirements, _ledger_requirement_text  # local import
...
def _build_completion_contract(
    ...
    *,
    ...
    from older_variants.harness.aether2.control.requirements import (  # local import
...
def _build_completion_evidence_gate_report(
    ...
    *,
    ...
    from older_variants.harness.aether2.control.requirements import _primary_requirement  # local import
