...
This directory is retained for compatibility and historical comparison. It is not the current Proteus harness. The current canonical runtime is `proteus/aether_next/`; the public product facade is `proteus/`.
