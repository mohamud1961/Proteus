...
from older_variants.harness.aether2.traces.dt_observation_summarize import (
...
def _extract_verification_gaps_from_row(row: dict[str, Any] | None) -> list[dict[str, Any]]:
    gaps: list[dict[str, Any]] = []
    from older_variants.harness.aether2.traces.dt_receipts import _extract_row_discrepancy_reports
