...
Verifier-report parsing lives in ``older_variants.harness.aether2.traces.verifier``.
...
def mark_blockers_candidate_resolved(
    ...
    *,
    ...
    from older_variants.harness.aether2.traces.evidence_ledger import compact_evidence_ledger
...
def _normalize_blocker(value: Mapping[str, Any]) -> dict[str, Any]:
    ...
    from older_variants.harness.aether2.traces.evidence_ledger import _requirement_id, _normalize_requirement_status
...
def _build_blocker_id(
    *,
    ...
    from older_variants.harness.aether2.traces.evidence_ledger import _normalize_requirement_status
