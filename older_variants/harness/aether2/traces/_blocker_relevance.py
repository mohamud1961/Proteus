...
def _current_blocker_evidence_version(
    ...
    *,
    ...
    from older_variants.harness.aether2.traces.evidence_ledger import _requirement_map
    from older_variants.harness.aether2.traces.blockers import compute_relevant_evidence_version
    from older_variants.harness.aether2.traces.verifier import _infer_evidence_classes
