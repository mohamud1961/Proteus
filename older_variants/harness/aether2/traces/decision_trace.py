...
from older_variants.harness.aether2.traces.dt_row_loading import (
    _resolved,
    _extract_attempt_ref,
    _infer_run_ref,
    _load_row_records,
)
from older_variants.harness.aether2.traces.dt_receipts import (
    summarize_text,
    _short_json,
    _dedupe_dicts,
...
from older_variants.harness.aether2.traces.dt_event_extraction import (
...
def _build_row_bundle(record: dict[str, Any]) -> dict[str, Any]:
    ...
    for path in external_receipt_paths:
        ...
        if path.name == "run_events.jsonl":
            ...
            from older_variants.harness.aether2.traces.dt_row_loading import _read_text, _loads_json
            ...
            for line_no, line in enumerate(text.splitlines(), start=1):
                ...
                if isinstance(payload, dict):
                    ...
                    from older_variants.harness.aether2.traces.dt_event_extraction import _summarize_route_receipt
