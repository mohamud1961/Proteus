...
def _build_blocker_from_requirement_finding(
    ...
    *,
    ...
    from older_variants.harness.aether2.traces.verifier import _normalize_terminal_evidence_class
...
def _build_blocker_from_structure_finding(
    *,
    ...
    from older_variants.harness.aether2.traces.evidence_ledger import _requirement_id
    from older_variants.harness.aether2.traces.blockers import (
        _build_blocker_id,
        compute_relevant_evidence_version,
    )
