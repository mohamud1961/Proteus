...
from older_variants.harness.aether2.agents.loader import AgentDefinition, AgentMcpServerSpec
from older_variants.harness.aether2.skills.loader import SkillHookMetadata
