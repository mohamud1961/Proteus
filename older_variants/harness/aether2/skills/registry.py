...
if False:  # pragma: no cover
    from older_variants.harness.aether2.skills.loader import ParsedSkillFrontmatter, SkillLoadIssue, SkillLoadResult, SkillSpec
...
def get_mcp_skill_builders() -> MCPSkillBuilders:
    if _mcp_skill_builders is None:
        raise RuntimeError(
            "MCP skill builders not registered — older_variants.harness.aether2.skills.loader has not been evaluated yet"
        )
...
def materialize_bundled_skill(
    ...
    *,
    ...
    from older_variants.harness.aether2.skills.loader import SkillHookMetadata, create_skill_spec
...
class SkillRegistry:
    ...
    def select(
        ...
        *,
        ...
        from older_variants.harness.aether2.skills.loader import skill_matches_paths
