...
from older_variants.harness.aether2.skills.registry import MCPSkillBuilders, register_mcp_skill_builders
from older_variants.harness.aether2.skills.skill_types import (
    LoadedFrom,
