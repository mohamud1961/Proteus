...
def _classify(reason_codes, fallback):
    mapping = {
        "final_value_mismatch": "retrieval_reduction",
        "missing_required_evidence_id": "retrieval_reduction",
        "stale_id_not_rejected": "retrieval_reduction",
        "missing_evidence_access_trace": "retrieval_reduction",
