...
def _classify(reason_codes, fallback):
    mapping = {
        "tool_name_mismatch": "tool_contract",
        "ticket_id_mismatch": "tool_contract",
        "owner_mismatch": "tool_contract",
        "missing_required_tool_call": "tool_contract",
        "missing_required_arg_tool_call": "tool_contract",
        "forbidden_tool_call": "tool_contract",
        "missing_dispatch_receipt": "verification_completion",
        "receipt_status_mismatch": "verification_completion",
...
def main() -> int:
    ...
    if reason_codes:
        score = 0.0
        verdict = "fail"
        failure_class = _classify(reason_codes, base.get("failure_class", "tool_contract"))
