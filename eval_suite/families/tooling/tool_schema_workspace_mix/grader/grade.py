...
def _classify(reason_codes, fallback):
    mapping = {
        "tool_schema_order_violation": "tooling_tool_call",
        "dispatch_field_mismatch": "retrieval_reduction",
        "dispatch_commands_mismatch": "tooling_tool_call",
        "active_workspace_mismatch": "filesystem_path",
        "missing_dispatch_plan": "filesystem_path",
...
def main() -> int:
    ...
    if reason_codes:
        score = 0.0
        verdict = "fail"
        failure_class = _classify(reason_codes, base.get("failure_class", "tooling_tool_call"))
