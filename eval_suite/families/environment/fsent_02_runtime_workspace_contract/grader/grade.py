...
def _classify(reason_codes, fallback):
    mapping = {
        "python_command_mismatch": "environment_toolchain",
        "workspace_root_mismatch": "filesystem_path",
        "runner_command_mismatch": "environment_toolchain",
        "runtime_classification_invalid": "verification_completion",
        "trace_workspace_root_mismatch": "filesystem_path",
