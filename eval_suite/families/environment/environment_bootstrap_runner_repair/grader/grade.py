...
def _classify(reason_codes, fallback):
    mapping = {
        "missing_toolchain_repair_report": "environment_toolchain",
        "missing_patches_applied": "filesystem_path",
        "runner_command_mismatch": "environment_toolchain",
        "package_manager_invalid": "environment_toolchain",
        "preflight_not_successful": "environment_toolchain",
        "missing_required_patch_reference": "filesystem_path",
        "runner_script_missing": "filesystem_path",
        "runner_script_not_patched": "filesystem_path",
...
def main() -> int:
    ...
    base = module["evaluate"](hidden_truth_path, Path(args.candidate).resolve(), trace)
    ...
    if reason_codes:
        score = 0.0
        verdict = "fail"
        failure_class = _classify(reason_codes, base.get("failure_class", "environment_toolchain"))
