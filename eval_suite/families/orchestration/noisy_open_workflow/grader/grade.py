...
def _classify(reason_codes, fallback):
    mapping = {
        "wrong_ticket_selection": "retrieval_reduction",
        "wrong_owner_selection": "retrieval_reduction",
        "missing_required_evidence": "retrieval_reduction",
        "distractor_not_rejected": "retrieval_reduction",
        "missing_closure_report": "filesystem_path",
...
def main() -> int:
    ...
    if reason_codes:
        score = 0.0
        verdict = "fail"
        failure_class = _classify(reason_codes, base.get("failure_class", "retrieval_reduction"))
