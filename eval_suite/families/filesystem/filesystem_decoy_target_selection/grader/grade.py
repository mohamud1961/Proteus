...
def _classify(reason_codes, fallback):
    mapping = {
        "missing_target_file": "filesystem_path",
        "target_patch_missing": "filesystem_path",
        "decoy_file_modified": "filesystem_path",
        "candidate_target_mismatch": "filesystem_path",
        "candidate_decoy_claim_missing": "verification_completion",
...
def main() -> int:
    ...
    if reason_codes:
        ...
        failure_class = _classify(
            reason_codes, base.get("failure_class", "filesystem_path")
        )
