...
from proteus.aether_next.kernel_verifier import run_model_verifier_if_available
from proteus.aether_next.kernel_verifier import _execute_compiled_inspection_fallbacks
from proteus.aether_next.ledger import ExecutionLedger, Receipt
from proteus.aether_next.runners.docker_runner import KernelRunTimeout, _kernel_wall_timeout
from proteus.aether_next.tracing import RunTrace
from proteus.aether_next.verifier import ModelVerifierResult, VerifierFinding
from proteus.aether_next.verifier_inspector import VerifierInspectionRequest
from proteus.aether_next.verifier_packets import build_verifier_packet
from proteus.aether_next.task_contract import TaskClause, TaskContract
from proteus.aether_next.world import WorldState
...
def test_scoped_verifier_evidence_dir_prevents_cross_task_collision(tmp_path, monkeypatch) -> None:
    ...
    """
    from proteus.aether_next.runners.docker_runner import _scoped_verifier_evidence_dir
