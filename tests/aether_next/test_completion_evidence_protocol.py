...
from proteus.aether_next.model_hooks import (
    ModelHooks,
...
from proteus.aether_next.runtime_ir import CapabilityDescriptor, EnvMap, RuntimeConfigIR
from proteus.aether_next.proof_contract import ROUTE_EVIDENCE_CEILINGS
from proteus.aether_next.verifier import (
...
from proteus.aether_next.workbench_compile import harness_config_to_runtime_ir
from proteus.aether_next.workbench_config import parse_harness_config_ir
from proteus.aether_next.workbench_prompt import WORKBENCH_ARCHITECT_SYSTEM_PROMPT
...
def test_context_window_bounds_are_fail_closed() -> None:
    from proteus.aether_next.model_hooks import ModelOutputError
