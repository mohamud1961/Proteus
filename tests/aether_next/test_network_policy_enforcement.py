...
from proteus.aether_next.monitors import LocalOnlySafetyGuard
from proteus.aether_next.network_policy import (
    EXTERNAL_UNRESTRICTED,
    LOOPBACK_ONLY,
    resolve_network_policy,
)
from proteus.aether_next.runners.docker_runner import _build_task_container_command
from proteus.aether_next.runtime_ir import ActionRequest, CapabilityDescriptor, EnvMap, RuntimeConfigIR
...
def test_envmap_reports_enforced_policy_not_post_start_probe(tmp_path: Path) -> None:
    ...
    request = __import__("proteus.aether_next.kernel_messages", fromlist=["build_architect_request"]).build_architect_request(
        envmap,
