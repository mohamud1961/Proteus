...
from proteus.aether_next.runners.docker_runner import DockerExecExecutor, run_tbench_task
...
class TestGitSafeDirConstant:
    ...
    def test_constant_contains_safe_directory(self) -> None:
        from proteus.aether_next.runners.docker_runner import _GIT_SAFE_DIR_CMD
...
class TestEffectiveRunTimeout:
    def test_task_declared_budget_raises_runner_floor(self) -> None:
        from proteus.aether_next.runners.docker_runner import _effective_run_timeout_s
    ...
    def test_declared_budget_is_capped_and_never_lowers_floor(self) -> None:
        from proteus.aether_next.runners.docker_runner import (
            _MAX_RUN_TIMEOUT_S,
