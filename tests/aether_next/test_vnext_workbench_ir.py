...
from proteus.aether_next.architect_quality import score_architect_config
from proteus.aether_next.compiler import CapabilityRegistry, ConfigCompiler
from proteus.aether_next.runtime_manual import ALLOWED_VISIBLE_SMOKE_TEST_TYPES, build_runtime_manual
from proteus.aether_next.runtime_ir import CapabilityDescriptor, EnvMap, FIXED_KERNEL_TOOL_SURFACE
from proteus.aether_next.workbench_compile import (
    TOP_LEVEL_CONFIG_FIELDS,
    config_realization_audit,
    harness_config_to_runtime_ir,
    realization_preview,
)
from proteus.aether_next.workbench_config import (
...
from proteus.aether_next.workbench_hooks import WORKBENCH_ARCHITECT_SYSTEM_PROMPT, WorkbenchArchitect
