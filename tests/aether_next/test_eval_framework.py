...
from eval_suite.evals.checks import BUILTINS
from eval_suite.evals.framework import run_manifest
...
def test_all_manifest_builtins_are_registered() -> None:
    payload = json.loads((BUILD_ROOT / "eval_suite" / "evals" / "manifest.v1.json").read_text(encoding="utf-8"))
