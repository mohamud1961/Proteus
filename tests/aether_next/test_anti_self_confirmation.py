...
from proteus.aether_next.classifier import HarnessLimiterClassifier
from proteus.aether_next.kernel import KernelResult
from proteus.aether_next.ledger import Receipt
from proteus.aether_next.workbench_hooks import WORKBENCH_ARCHITECT_SYSTEM_PROMPT
...
def test_turn_parser_infers_act_and_tolerates_missing_boilerplate() -> None:
    ...
    import pytest
    from proteus.aether_next.model_hooks import ModelOutputError, parse_solver_turn
