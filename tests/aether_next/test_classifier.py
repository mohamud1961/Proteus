"""Tests for proteus.aether_next.classifier.reconcile_grader_alignment."""
from __future__ import annotations

from proteus.aether_next.classifier import reconcile_grader_alignment
...
def test_environment_failure_records_are_consistent() -> None:
    ...
    from proteus.aether_next.runners.docker_runner import _error_record, _timeout_record
