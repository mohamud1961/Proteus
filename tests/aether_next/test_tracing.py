...
def test_write_trace_file_matches_docker_runner_call_signature(tmp_path) -> None:
    ...
    """
    from proteus.aether_next.runners.docker_runner import _write_trace_file
...
def test_trace_write_helper_records_path_and_error_detail(tmp_path) -> None:
    ...
    from proteus.aether_next.runners.docker_runner import _write_trace_file_to_record
