...
```bash
PYTHONPATH=. .venv-fix/bin/python \
  tools/replay_engine/builder.py \
  --root . \
  --out tools/replay_engine/generated/historical_replay_manifest.json
```
...
```bash
PYTHONPATH=. .venv-fix/bin/python \
  tools/replay_engine/promotion.py \
  --manifest tools/replay_engine/generated/historical_replay_manifest.json \
  --out tools/replay_engine/generated/historical_replay_promotion_local.json
```
